...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-teal-900 via-blue-900 to-indigo-900 sticky z-50 top-0" style={{ height: "5rem" }}>
        ...
        <div className="flex items-center justify-between h-20">
          <div className="flex items-center">
            <Link to="/" className="text-white font-bold flex items-center">
              ...
              <span className="ml-2">Diabetes Prevention & Risk Monitoring System</span>
            </Link>
          </div>
          <div className="hidden 850px:block">
            <div className="ml-10 flex items-center space-x-4">
              ...
              <NavLink to="/FindDoctors" onClick={closeMenu}>
                FindDoctors
              </NavLink>
              <NavLink to="/analysis-report" onClick={closeMenu}>
                Analysis Report
              </NavLink>
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed top-0 right-0 h-full bg-blue-950 bg-opacity-95 z-50 transform ${isOpen ? "translate-x-0" : "translate-x-full"
