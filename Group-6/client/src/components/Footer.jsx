    ...
    <footer className="bg-gray-900 text-white py-10">
      <div className="container mx-auto flex flex-col md:flex-row justify-start items-start px-4 md:px-15 lg:px-100 space-y-8 md:space-y-0">
        ...
        <div className="w-full md:w-1/4 mb-8 md:mb-0">
          ...
          <ul className="space-y-2 text-lg">
            ...
            <li><Link to="/visualization" className="text-white hover:text-gray-400 transition-colors duration-300">Visualization</Link></li>
          </ul>
        </div>
        ...
        <div className="w-full md:w-1/4 mb-8 md:mb-0 md:px-10 lg:px-50">
          ...
          <div className="flex items-center text-gray-400 text-lg mb-4">
            ...
            <a href="#" className="text-gray-400 hover:text-white transition-colors duration-300 cursor-pointer">APSIT COLLEGE , THANE WEST</a>
          </div>
          <div className="flex items-center text-gray-400 text-lg mb-4">
            <FaEnvelope className="mr-2 text-2xl" />
            <a href="mailto:abc@gmail.com" className="text-gray-400 hover:text-white transition-colors duration-300 cursor-pointer">apsit_te_ds_b@gmail.com</a>
          </div>
        ...
        <div className="w-full md:w-1/4 mb-8 md:mb-0">
          ...
          <div className="flex space-x-4 text-2lg">
            ...
            <a href="https://www.linkedin.com/in/kalpesh-remje/" className="text-white hover:text-gray-400 transition-colors duration-300">
              <FaLinkedinIn className="text-2xl" />
            </a>
            <a href="https://github.com/Kalpesh0389" className="text-white hover:text-gray-400 transition-colors duration-300">
      ...
      <div className="border-t border-gray-800 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center px-6 md:px-12 lg:px-20">
        <div className="text-gray-400 text-center md:text-left mb-4 md:mb-0">
          { <p>&copy; 2026 Diabetes Prediction. All rights reserved.</p> }
        </div>
        <div>
          <a
            href="https://github.com/Kalpesh0389"
