        ...
        <div className="flex flex-col md:flex-row gap-10 bg-purple-100 justify-around items-center mb-8 md:mx-10 border p-4 rounded-md">
          ...
          >
            ...
            <p className="text-gray-700 mb-4">
              Explore and understand the data used for diabetes prediction.
              Analyze key features like age, BMI, blood pressure, cholesterol, and glucose.
              Identify patterns and correlations that affect diabetes risk.
              Gain insights to guide and improve prediction model performance.
            </p>
            <Link
              to="/analysis-report"
